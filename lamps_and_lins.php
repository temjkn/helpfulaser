<?php 
    ...
    $addParcellingActive="Лампы и линзы";
    ...
    <div class="margin" id="content_touch">
        ...
        <div class="content" id="content">
            <div class="porduct">
                ...
                <?php
                    $lins= get_lamp_all();
                    foreach($lins as $lamp): ?>
                <div class="product_card">
                        <img src=<?php echo $lamp ["image"];?>>
                        <p class="name_product"><?php echo $lamp ["name"];?></p>
                        <p class="price_product"><?php echo $lamp ["price"];?> Р</p>
                        <div>
                            <a href=product.php?id=<?php echo $lamp ["id"];?>><button>Подробнее</button></a>
                            <ul>
